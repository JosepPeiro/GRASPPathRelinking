# cd '.\Desktop\UNI\LOGÍSTICA BASADA EN DATOS\PROYECTO\GRASPPathRelinking\'
...
def saveFigure(best_count, avg_dev, time_start_str, max_time):
    _, (ax1, ax2) = plt.subplots(2, 1, figsize=(10, 5)) # 1 fila, 2 columnas, tamaño de la figura
...
def main():
    ...
    saveFigure(best_count, avg_dev, time_start_str, max_time)
